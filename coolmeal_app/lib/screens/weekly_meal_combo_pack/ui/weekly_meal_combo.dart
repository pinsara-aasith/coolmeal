...
class WeeklyMealComboPage extends StatelessWidget {
  final VoidCallback onGetStarted;

  const WeeklyMealComboPage({Key? key, required this.onGetStarted})
      : super(key: key);
...
class _ProfileCompletionScreenState extends State<ProfileCompletionScreen> {
  ...
  void initState() {
    _pages = [
      WeeklyMealComboPage(onGetStarted: () {
        _gotoPage(1);
      }),
